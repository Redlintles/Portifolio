...
class Matt {
    ...
    validate(n, dimension) {
        let message = dimension === "col" ? "Essa coluna não existe!" : "Essa linha não existe";
        let scope = dimension === "col" ? this.cols : this.rows;
        if (n === scope) {
            n--;
        }
        else if (n < 0 || n > scope) {
